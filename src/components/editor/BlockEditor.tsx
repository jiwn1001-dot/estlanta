...
export default function BlockEditor() {
  ...
  const [selectedId, setSelectedId] = useState<string>("machine-cult");
  ...
  // --- Faction Meta ---
  const updateFactionMeta = (field: 'name' | 'subtitle' | 'shortDesc', value: string) => {
    ...
    <div className="max-w-5xl mx-auto p-12 bg-[#111] min-h-screen text-gray-200">
      ...
      {activeTab === 'faction' && (
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4">
          <div className="bg-white/5 p-4 rounded-lg border border-gray-800 flex gap-4 items-center">
            ...
            >
              <option value="machine-cult">기계교단 (Machine Cult)</option>
              <option value="outer-god">외신교단 (Outer God Cult)</option>
              <option value="new-london">뉴 런던 (New London)</option>
              <option value="escova-city">에스코바 시티 (Escova City)</option>
            </select>
          </div>
